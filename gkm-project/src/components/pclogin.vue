  ...
  <div class="pclogin">
      ...
      <div class="contents">
        <div class="left">
          ...
          <div class="eng">
            WALK BOOKSHOP BACKGROUNG MANAGEMENT SYSTEM
          </div>
        </div>
        <div class="right">
          <div class="login_infos">
            ...
            <input type="text"  class="us" placeholder="邮箱账号" v-model.trim="username">
            ...
            <div class="foots">
              ...
              记住密码
               <button @click="loginSystem()">登陆</button>
            </div>
          </div>
  ...
  methods:{
    async loginSystem() {
      ...
      if(res.code!==200){
        ...
        window.sessionStorage.setItem("xzsdtoken",res.token)
         this.$router.push({
          path:'/pchomepages'
        })
      }
